...
class AverageMeter:
    ...
    def __init__(self, dataset):
        ...
        self.class_ids_interest = dataset.class_ids #  60
        ...
        self.intersection_buf = torch.zeros([2, self.nclass]).float().cuda() # torch.Size([2, 80])
        self.union_buf = torch.zeros([2, self.nclass]).float().cuda() # torch.Size([2, 80])
