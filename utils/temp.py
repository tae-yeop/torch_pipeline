...
# 'support_imgs' : torch.Size([2, 1, 3, 512, 512]),  torch.Size([2, 1, 512, 512]) # [['COCO_train2014_000000057699', 'COCO_train2014_000000187952']]
# 'query_img' : torch.Size([2, 3, 512, 512]), torch.Size([2, 512, 512]), ['COCO_train2014_000000080562', 'COCO_train2014_000000408258'], [tensor([499, 640]), tensor([500, 478])]
def to_cuda(batch):
